...
import com.mtm.entities.Applicant;
import com.mtm.entities.Job;
import com.mtm.helper.SFRegistry;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /*Job job1 = Job.of().jobTitle("Senior Java Developer").company("Oracle India Pvt Ltd")
                    .description("Java Specialist with > 8 years").qualification("Masters")
                    .experience(8).build();
            session.persist(job1);
            System.out.println("job no : " + job1.getJobNo());


            Job job2 = Job.of().jobTitle("Devops Engineer").company("IBM")
                    .description("Devops Engineer with pipelines").qualification("Masters")
                    .experience(4).build();
            ...
            Job job3 = Job.of().jobTitle("Fullstack Java Developer").company("Amazon")
                    .description("Fullstack specialist").qualification("Masters")
                    .experience(6).build();
